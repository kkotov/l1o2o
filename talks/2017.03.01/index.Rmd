...
* <span style="font-family:monospace;font-size:smaller">./runL1-O2O-iov.sh 285832 collisions2016_TSC/v206 collisions2016_RS/v291</span>
...
A special case yet to be uploaded to the CondDB:

<span style="font-weight:bold;color:brown">CALO:</span>
[L1TCaloParams_Stage2v0_hlt](https://cms-conddb.cern.ch/cmsDbBrowser/list/Prod/tags/L1TCaloParams_Stage2v0_hlt_HI2016) - fully validated tag for 
end-of-2016 runs ($pp$, HI):
* comparison of raw data vs. emulator configured from O2O: e/$\gamma$ [ET](EgEt.pdf), [eta](EgEta.pdf), [phi](EgPhi.pdf)
