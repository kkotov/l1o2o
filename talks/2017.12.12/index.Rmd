...
* send the resulting sqlite to the new AlCa-L1T liaison
...
<span style="color:red">Avoid it unless you are left with no other choice</span>, for example:
...
System     |   Type[Tag]
-----------|-----------------
uGT        | [<span style="font-weight:bold;font-size:smaller;color:green">L1TUtmTriggerMenu[_Stage2v0_hlt]</span>](https://cms-conddb.cern.ch/cmsDbBrowser/list/Prod/tags/L1TUtmTriggerMenu_Stage2v0_hlt)
uGT RS     | [<span style="font-weight:bold;font-size:smaller;color:green">L1TGlobalPrescalesVetos[_Stage2v0_hlt]</span>](https://cms-conddb.cern.ch/cmsDbBrowser/list/Prod/tags/L1TGlobalPrescalesVetos_Stage2v0_hlt)
CALOL{1,2} | [<span style="font-weight:bold;font-size:smaller;color:green">L1TCaloParams[_Stage2v3_hlt]</span>](https://cms-conddb.cern.ch/cmsDbBrowser/list/Prod/tags/L1TCaloParams_Stage2v3_hlt)
uGMT       | [<span style="font-weight:bold;font-size:smaller;color:green">L1TMuonGlobalParams[_Stage2v0_hlt]</span>](https://cms-conddb.cern.ch/cmsDbBrowser/list/Prod/tags/L1TMuonGlobalParams_Stage2v0_hlt)

*** =right

System     |   Type[Tag]
-----------|-----------------
BMTF       | [<span style="font-weight:bold;font-size:smaller;color:red">L1TMuonBarrelParams[_Stage2v1_hlt]</span>](https://cms-conddb.cern.ch/cmsDbBrowser/list/Prod/tags/L1TMuonBarrelParams_Stage2v1_hlt)
OMTF       | [<span style="font-weight:bold;font-size:smaller;color:blue">L1TMuonOverlapParams[_Stage2v0_hlt]</span>](https://cms-conddb.cern.ch/cmsDbBrowser/list/Prod/tags/L1TMuonOverlapParams_Stage2v0_hlt)
EMTF       | [<span style="font-weight:bold;font-size:smaller;color:red">L1TMuonEndCapParams[_Stage2v3_hlt]</span>](https://cms-conddb.cern.ch/cmsDbBrowser/list/Prod/tags/L1TMuonEndCapParams_Stage2v3_hlt)
EMTF       | [<span style="font-weight:bold;font-size:smaller;color:blue">L1TMuonEndCapForest[_Stage2v1_hlt]</span>](https://cms-conddb.cern.ch/cmsDbBrowser/list/Prod/tags/L1TMuonEndCapForest_Stage2v1_hlt)
...
* static payloads that rarely change; whenever update is needed follow [the instructions](https://github.com/kkotov/l1o2o/)
...
## TODO for whoever takes over

Migrate O2O from <span style="color:green">cms-conddb-1.cms</span> (SLC6) to <span style="color:green">kvm-s3562-1-ip151-28.cms</span> (CentOS7)
* until [#20939](https://github.com/cms-sw/cmssw/pull/20939) is merged, setting up O2O working directory is a bit of an art
* after it is merged, another PR required to change O2O BMTF and EMTF tag versions
* in the same time IOVs from the last couple of months should be copied to new BMTF tag

Make helper classes intelligent and serve "default" values when non-existing data queried

Work-through activation of the "transaction unsafe" mode by the Function Manager
* if forced, O2O can complete transaction even when some subsystem component failed
* some call those components non-critical for data taking (but this creates big mess)
* shifter should be able to negotiate with O2O (via FM) to proceed 

Do not give up on explaining that code's backward compatibility with earlier conditions
is important. Otherwise it destroys the purpose of having conditions all together

--- .class #id

## Some potentially useful links

https://github.com/kkotov/l1o2o/

https://github.com/cms-sw/cmssw/tree/master/L1TriggerConfig/Utilities/test

http://kkotov.github.io/l1o2o/talks/2016.04.19

http://kkotov.github.io/l1o2o/talks/2017.03.20

http://kkotov.github.io/l1o2o/talks/2017.03.01

http://kkotov.github.io/l1o2o/talks/2015.04.20

https://kkotov.github.io/l1o2o.html
