---
title       : "Organization of information in OMDS"
subtitle    : 
...
* Vector Key presented as a small XML, thus it can include meta data (e.g. hash/CRC-sums)
  * potentially adopt Cond DB approach of hash sum keys with an additional description
...
* Interactions with DB can be hidden in swatch given format of Vector Keys is enforced
