...
Besides L1TMenu and prescales/vetos following tags need to be aggregated by HI Global Tags:
...
<span style="font-weight:bold;color:brown">CALO:</span>
[L1TCaloParams_Stage2v0_hlt_HI2016](https://cms-conddb.cern.ch/cmsDbBrowser/list/Prod/tags/L1TCaloParams_Stage2v0_hlt_HI2016)

We are still validating CALO payload for the pp runs

--- .class #id


## L1T tags for Monte Carlo GTs

Besides L1TMenu following tags are needed to configure L1T emulators from CondDB (for pp):
